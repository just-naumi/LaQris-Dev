    ...
    <div className="min-h-screen bg-neutral-900 py-0 sm:py-8 flex items-center justify-center font-sans antialiased">
      ...
      <div className="w-full max-w-[390px] h-[844px] bg-white sm:rounded-[44px] shadow-2xl overflow-hidden flex flex-col justify-between p-8 relative border-0 sm:border-[8px] border-neutral-800 text-neutral-900">
        ...
        <div className="pt-6 relative z-10 flex items-center justify-between">
          ...
          <Link href="/" className="text-xs font-semibold text-neutral-400 hover:text-neutral-900 transition-colors">
            Back
          </Link>
        </div>

        {/* MIDDLE REGISTER FORM CONTENT */}
        <div className="my-auto space-y-5 relative z-10 pt-2">
          ...
          <form onSubmit={handleSubmit} className="space-y-3 pt-2">
            ...
            <button
              type="submit"
              className="w-full mt-2 py-3.5 px-6 rounded-full bg-neutral-900 hover:bg-neutral-800 text-white font-bold text-xs transition-all duration-200 active:scale-[0.98] shadow-lg shadow-neutral-900/10"
            >
              Register
            </button>
          </form>
          ...
          <div>
            <button
              ...
              className="w-full py-3 px-4 rounded-full bg-neutral-50 hover:bg-neutral-100 text-neutral-900 font-semibold text-xs transition-all flex items-center justify-center gap-2 border border-neutral-200 shadow-sm"
            >
        ...
        <div className="pb-4 text-center relative z-10">
          <p className="text-xs font-medium text-neutral-400">
            ...
            <Link href="/" className="font-bold text-neutral-900 underline underline-offset-2 hover:text-primary transition-colors">
              Login Here
            </Link>
          </p>
        </div>
